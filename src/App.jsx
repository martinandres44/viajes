...
const [form, setForm] = useState({ description: “”, amount: “”, category: “food”, payment: “visa”, bank: “galicia”, date: getMiamiToday(), notes: “” });
...
setForm({ description: “”, amount: “”, category: “food”, payment: “visa”, bank: “galicia”, date: getMiamiToday(), notes: “” });
setAdding(false);
};
...
const path = `shopping/${itemId}_${Date.now()}_${file.name}`;
